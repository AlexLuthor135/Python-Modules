...
Make sure your exercise files exist and the main.py is in the main folder!
"""
...
def test_ft_exercise(exercise_file_name, exercise_number):
    ...
    try:
        ...
        import sys
        exercise_path = (f"./ex{exercise_number}")
...
def main():
    ...
    if choice in exercises:
        for exercise in exercises[choice]:
            test_ft_exercise(exercise, choice)
    elif choice == "a":
        for number, exercise_files in exercises.items():
            for exercise in exercise_files:
                test_ft_exercise(exercise, number)
    else:
